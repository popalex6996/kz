const resources = {
  ua: {
    translation: {
      ...
      'no-feedback': 'Тут досі немає відгуку, мершій стань першим хто лишить відгук',
      ...
      'no-category': 'Схоже що всі доступні товари цієї категорії вже розібрали',
      ...
      'user-no-favourites': 'У Вас поки що немає доданих товарів у списку бажань',
      order: 'Замовлення',
      status: 'Статус',
      delivery: 'Доставка',
  ...
  en: {
    translation: {
      ...
      'no-feedback': 'There are no feedback yet, be the first to leave a feedback',
      ...
      'goods for garden and vegetable garden': 'Goods for garden and vegetable garden',
      ...
      platformDescription: 'Online platform for agricultural trade in Koziyivka district',
      platformFeatures: 'Platform features',
      'platform-feature-1': 'Free placement of your products',
      'platform-feature-2': 'There are no restrictions on the number of added products',
      ...
      'user-no-favourites': 'You have not added any products to your wish list yet',
      order: 'Order',
      status: 'Status',
      delivery: 'Delivery',
      ...
      'total-price': 'Total:',
      'cart-terms-title': 'By confirming the order, I accept the terms and conditions:',
