    ...
    <div className="delivery-form">
      <div
        className={`delivery-option ${
          delivery === "sd" && "active-delivery-option"
        }`}
      ...
      >
        ...
        {delivery === "sd" && (
          <div className="delivery-option-details">
            <span className="delivery-option-details-text">
              {t("freeDeliveryText")}
            </span>
          </div>
        )}
      ...
      <div
        className={`delivery-option ${
          delivery === "np" && "active-delivery-option"
        }`}
      ...
      >
        <div className="delivery-option-input">
          ...
          <label htmlFor="np" className="delivery-option-label">
            ...
            <span className="delivery-option-price-text">
              ({t("npTariff")})
            </span>
          </label>
        </div>
        ...
        {delivery === "np" && (
          <div className="delivery-option-details">mkljnk</div>
        )}
      </div>

      <div
        className={`delivery-option ${
          delivery === "up" && "active-delivery-option"
        }`}
