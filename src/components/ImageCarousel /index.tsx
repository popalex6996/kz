  ...
  return (
    <div className="slider-wrapper">
      <div className="open-image-btn-wrapper">
        <Button onClick={toggleGallery} icon="expand" iconClassName="fa-solid" color="#711d1d" />
      </div>
      <div className="slider">
        <div
          className="slide-items"
          style={selected >= 1 ? { transform: `translateX(-${selected * 200}px` } : {}}
        >
          {images.map((img) => (
            <img
              key={img.title + 'image'}
        ...
        <ul onClick={handleClick} className="indicators">
          <Button
            onClick={() => setSelected(selected - 1 < 0 ? images.length - 1 : selected - 1)}
            icon="caret-left"
          ...
          <Button
            onClick={() => setSelected(selected + 1 === images.length ? 0 : selected + 1)}
            icon="caret-right"
            iconClassName="fa-solid"
            color="#711d1d"
          />
